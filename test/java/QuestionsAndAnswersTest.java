...
public class QuestionsAndAnswersTest {
    // параметр текста ответа
    private String expectedAnswer;

    // параметр номера проверяемой строки
    private Integer questionNumber;

    private WebDriver driver;

    public QuestionsAndAnswersTest(String expectedAnswer, Integer questionNumber) {
        this.expectedAnswer = expectedAnswer;
        this.questionNumber = questionNumber;
    }

    @Parameterized.Parameters
    public static Object[] getExpectedAnswer() {
        return new Object[] [] {
    ...
    public void checkQuestionAndAnswers() {
        ...
        objSamokatMainPage.assertQuestionListItems(expectedAnswer, questionNumber);
